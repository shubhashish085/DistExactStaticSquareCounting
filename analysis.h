...
public:
    ...
    static void analyse_replication_factor_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    static void analyse_edge_replication_factor_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_replication_factor_kahip_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_edge_replication_factor_kahip_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_replication_factor_for_bidirectional_edges_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_edge_replication_factor_for_bidirectional_edges_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_replication_factor_for_bidirectional_edges_kahip_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
    ...
    static void analyse_edge_replication_factor_for_bidirectional_edges_kahip_sqrd_opt(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count);
