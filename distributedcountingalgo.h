...
public:
    ...
    static void optimized_db_count_square_in_whole_ptn_graph_parallel_kahip_detail(const std::string& file_path, const std::string& vertex_partition_file_path, int partition_count); 
