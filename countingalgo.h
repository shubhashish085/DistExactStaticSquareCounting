...
public:
    ...
    static long long sequential_db_count_square_with_only_core_ordering(Graph* graph);
    ...
    static long long bfy_count_in_multi_ptns_from_bipartite_graph(Graph* graph, int partition_no);
